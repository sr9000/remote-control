...
namespace gma.System.Windows
{
    ...
    public class UserActivityHook
    {
        ...
        /// <summary>
        /// represent method, that process handled mouse events.
        /// </summary>
        public delegate void HandledMouseEventHandler(object sender, HandledMouseEventArgs e);

        /// <summary>
        /// Occurs when the user moves the mouse, presses down/up any mouse button or scrolls the wheel
        /// </summary>
        public event HandledMouseEventHandler OnMouseActivity;
        /// <summary>
        /// Occurs when the user moves the mouse, presses down any mouse button or scrolls the wheel
        /// </summary>
        public event HandledMouseEventHandler OnMouseDown;
        /// <summary>
        /// Occurs when the user moves the mouse, presses up any mouse button or scrolls the wheel
        /// </summary>
        public event HandledMouseEventHandler OnMouseUp;
        /// <summary>
        ...
        private int MouseHookProc(int nCode, int wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (OnMouseActivity != null || OnMouseDown != null || OnMouseUp != null))
            {
                ...
                //generate event 
                HandledMouseEventArgs e = new HandledMouseEventArgs(
                                                    button,
                                                    clickCount,
                ...
                //update handled flag after OnActivity event
                handled = handled || e.Handled;
                e.Handled = false;
                if (isDown.HasValue)
                {
                    if (isDown.Value && (OnMouseDown != null))
                        OnMouseDown(this, e);
                    else if (OnMouseUp != null)
                        OnMouseUp(this, e);
                    //update handled flag after OnDown or OnUp mouse event
                    handled = handled || e.Handled;
                }
            }
